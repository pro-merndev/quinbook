...
const ForWhomQuinbookBanner = () => {
  ...
  return (
    ...
    <Banner title="FÜR WEN QUINBOOK?" description="Business Management einfach gemacht:  Optimiere deinen Workflow" button={<PrimaryButton onClick={handleScroll}>{commonT("learn_more")}</PrimaryButton>} />
