    ...
    <section id="pricing">
      <div className="container">
        <FadeIn>
          ...
          <h3 className="text-center font-poppins text-4xl lg:text-[42px] font-extrabold uppercase py-5">Flatrate pakete</h3>
        </FadeIn>
        <div className="grid lg:grid-cols-4 sm:grid-cols-2 gap-6 mt-10 overflow-x-hidden">
          {pricingPlans.map((plan, index) => (
            <FadeIn key={index} direction={index % 2 === 0 ? "left" : "right"}>
              <div className="px-6 py-9 bg-white even:bg-grey-main rounded-3xl border border-grey-main hover:bg-grey-main transition-all duration-500 ">
