...
export const Icons = {
  ...
  menu: (props: IconProps) => (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <path d="M1.28613 7.71423H22.7147" stroke="currentColor" stroke-width="2" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M1.28613 16.2856H22.7147" stroke="currentColor" stroke-width="2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  ),
